...
public class ScintificCalculator extends JFrame implements ActionListener {
  ...
  int k = 1, x = 0, y = 0, z = 0;
  char ch;
  JButton b1, b2, b3, b4, b5, b6, b7, b8, b9, zero, clr, pow2, pow3, exp, fac,
      plus, min, div, log, rec, mul, eq, addSub, dot, mr, mc, mp, mm, sqrt, sin,
      cos, tan;
  Container cont;
  ...
  public static void main(String args[]) {
    ...
    ScintificCalculator f = new ScintificCalculator();
